...
const SignupContent = () => {
    ...
    const handleSubmit = (e) => {
        ...
        alert('Signup functionality is currently disabled as authentication has been removed.');
        console.log('Signup disabled. Data:', { planType, billingCycle, formData, familyMembers });
    };
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        {[1, 2, 3, 4].map((num) => (
                            <div key={`step_${num}`} className="flex items-center">
                                <div
                                    className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-lg transition-all duration-300 ${step >= num
                                ...
                                {num < 4 && (
                                    <div
                                        className={`w-8 md:w-16 h-1 mx-2 rounded-full transition-all duration-500 ${step > num ? 'bg-[#4988C4]' : 'bg-slate-200'
                                            }`}
                                    />
                                )}
                            </div>
                            ...
                            {step === 1 && (
                                <div className="space-y-8">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <label
                                            className={`relative p-6 border-2 rounded-2xl cursor-pointer transition-all duration-300 hover:-translate-y-1 ${planType === 'individual' ? 'border-[#1C4D8D] bg-[#1C4D8D]/10 shadow-md' : 'border-slate-100 hover:border-[#1C4D8D]/30 hover:shadow-lg'
                                                }`}
                                        >
                                            <input
                                                type="radio"
                                        ...
                                        <label
                                            className={`relative p-6 border-2 rounded-2xl cursor-pointer transition-all duration-300 hover:-translate-y-1 ${planType === 'family' ? 'border-[#1C4D8D] bg-[#1C4D8D]/10 shadow-md' : 'border-slate-100 hover:border-[#1C4D8D]/30 hover:shadow-lg'
                                                }`}
                                        >
                                            <input
                                                type="radio"
                                    ...
                                    <div className="bg-slate-50 rounded-2xl p-2 flex items-center justify-center gap-2 max-w-md mx-auto">
                                        <button
                                            ...
                                            className={`flex-1 px-6 py-3 rounded-xl font-semibold transition-all duration-300 ${billingCycle === 'monthly' ? 'bg-white text-slate-900 shadow-md' : 'text-slate-500 hover:text-slate-900'
                                                }`}
                                        >
                                            Monthly
                                        </button>
                                        <button
                                            ...
                                            className={`flex-1 px-6 py-3 rounded-xl font-semibold transition-all duration-300 relative ${billingCycle === 'annual' ? 'bg-white text-slate-900 shadow-md' : 'text-slate-500 hover:text-slate-900'
                                                }`}
                                        >
                                            Annual
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-start gap-3 pt-4">
                                        ...
                                        <label htmlFor="terms" className="text-sm text-muted-foreground">
                                            I agree to the{' '}
                                            <Link to="/terms" className="text-[#0F2854] hover:underline">
                                                Terms of Service
                                            </Link>{' '}
                                            and{' '}
                                            <Link to="/privacy-policy" className="text-[#0F2854] hover:underline">
                                                Privacy Policy
                                            </Link>
                                        </label>
                                    </div>
