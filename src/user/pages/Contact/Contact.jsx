              ...
              <div className="relative z-10">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                      type="submit"
                      className="w-full px-8 py-4 bg-[#0F2854] text-white text-primary-foreground rounded-xl text-lg font-bold hover:bg-[#1C4D8D] transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 transform hover:-translate-y-0.5"
                    >
                      Send Message
