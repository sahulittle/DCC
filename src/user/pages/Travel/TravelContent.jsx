    ...
    return (
        <div className="min-h-screen bg-background">
                ...
                <div className="py-20">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="flex items-center justify-between mb-8">
                            <h2 className="font-heading text-3xl font-bold text-foreground">Featured Deals</h2>
                        </div>
                                ...
                                <div key={deal.id} className="bg-white rounded-2xl overflow-hidden border border-border hover:shadow-xl transition-all group">
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="flex items-end gap-3 mb-4">
                                            {deal.regular_price && (
                                                <span className="text-muted-foreground line-through text-sm">${deal.regular_price}</span>
                                            )}
                                            <span className="text-3xl font-bold text-primary">${deal.member_price}</span>
                                            {deal.savings_amount && (
                                                <span className="text-success font-semibold text-sm">Save ${deal.savings_amount}</span>
                                            )}
                                        </div>
            ...
            <div className="py-20 bg-gradient-to-br from-primary/5 to-secondary/5">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex items-center justify-between mb-8">
                        <h2 className="font-heading text-3xl font-bold text-foreground">All Travel Deals</h2>
